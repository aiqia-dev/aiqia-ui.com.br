...
declare const DateTimePicker: React.ForwardRefExoticComponent<{
     ...
     **/
    defaultPopupValue?: Date;
} & Pick<DayPickerProps, "showOutsideDays" | "locale" | "showWeekNumber" | "weekStartsOn"> & {
    disabledDates?: DayPickerProps["disabled"];
} & Omit<DayPickerProps, "onSelect" | "mode" | "selected"> & React.RefAttributes<Partial<DateTimePickerRef>>>;
